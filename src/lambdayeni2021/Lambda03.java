...
public class Lambda03 {
    public static void main(String[] args) {
        ...
        List<String> list = new ArrayList<>(Arrays.asList("mehmet","emre","nilgun","yıldız","kader","emine","islam","islam","emre"));
    ...
    //List elemanlarini alfabetik buyuk harf sirasiyla ile ve tekrarsiz

    public static void bykHrfTekrarsizSira(List<String>list){
        list.stream().//akisa girdi
                map(t->t.toUpperCase()).//elemanlar byk harf update edildi
                sorted().//alfabetik sira
                distinct().// tekrarsiz yapildi  ***onemli
    ...
    public static void karakterSayisiSiraliEl(List<String> list) {
       list.
                ...
                forEach(t -> System.out.print(t + " "));  //emre emre kader emine islam islam mehmet nilgun yıldız
    ...
    public static void sonHarfTersSiraliEl(List<String> list) {
        list.
                ...
                forEach(t -> System.out.print(t + " "));    //yıldız mehmet kader nilgun islam islam emre emine emre
    }
    ...
    public static void ciftKareTekrarsizTersSira(List<String> list) {
        list.
                ...
                forEach(Lambda01::printEl);//yazdirilidiş            //36 16
    ...
    public static void harfSayisi7Kontrol(List<String> list) {
        ...
        System.out.println(list.stream().allMatch(t -> t.length() <= 7)?"list elemanlari 7 harfden buyuk degil":"AGAM list elemanlari 7 harfden BUYUK "); //list elemanlari 7 harfden buyuk degil
    }
...
//noneMatch() --> hic bir sarti SAGLAMAZSA true en az bir eleman sarti SAGLARSA false return eder.
    ...
    public static void karakteriEnBuyukEl(List<String> list){
        System.out.println(list.
                ...
                findFirst());//ilk elelmani aldi   Optional[mehmet]

    }

    //Karakter sayisi en buyuk elemani yazdiriniz.  2.YOL
    public static void karakteriEnBuyukEl2(List<String> list){
        Stream< String > sonIsim=list.
                stream().
                sorted(Comparator.comparing(t -> t.toString().length()).//lenght karakter uzunluguna gore siraladi k->b
                        reversed()).//ters sirladi b->k

                        limit(5); //  ilk 5 elemani verir  limit 1 yazarsak ilk elemani verir
        System.out.println(Arrays.toString(sonIsim.toArray())); //[mehmet, nilgun, yıldız, kader, emine]

    }

    public static void ilkElemanHaricSonHarf(List<String> list) {
        list.
                stream().sorted(Comparator.comparingLong(t->t.toString().charAt(t.length()-1))).skip(1).forEach(t-> System.out.print(t+ " "));
                             //emine emre islam islam nilgun kader mehmet yıldız         son harflerine gore siraladi
    }
